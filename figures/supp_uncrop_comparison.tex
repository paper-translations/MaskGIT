...
%    \vspace{-3mm}
   % \vspace{-4mm}
    \vspace{-2mm}   
    \caption{\textbf{More visual comparisons on image outpainting.} with state-of-the-art GAN methods. \ding{83} samples are graciously provided by the authors.
    }
...
\end{tabular}
\vspace{-3mm}
\caption{Visual comparisons of outpainting with CoModGAN\cite{zhao2021comodgan} on large outpainting mask.}
% \vspace{-4mm}
