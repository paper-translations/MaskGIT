...
\begin{figure*}[!ht]
    ...
    \end{tabular}
    \caption{\textbf{More diversity comparisons} between BigGAN-deep with truncation $1.0$, VQVAE-2\cite{vqvae2}, and our proposed method \model on ImageNet. $^\dagger$ represents extracted samples from the paper.}
    \vspace{-6mm}
...
\end{tabular}
    \caption{More Diversity Comparisons among BigGAN-deep with truncation $1.0$, VQVAE-2\cite{vqvae2}, and our proposed method \model on ImageNet. $^\dagger$ represents extracted samples from the paper.}
    \vspace{-6mm}
